...
void exceprion_handler_unknown(void);
...
void irq_init(void)
{
    ...
    {
        gate_desc_set(idt_table + i, KERNEL_SELECTOR_CS, (uint32_t)exceprion_handler_unknown, GATE_P_PRESENT | GATE_DPL0 | GATE_TYPE_INT);
    }
